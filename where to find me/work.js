...
var contents = "<option selected>" + 'Date' + "</option>";
for (let i = 1; i <= 31; i++) {
    contents += "<option>" + i + "</option>";
}
selectDay.innerHTML = contents;
var selectYear = document.getElementById('year');
var contents2 = "<option selected>" + 'Year' + "</option>";
for (let i = 2020; i >= 1900; i--) {
    contents2 += "<option>" + i + "</option>";
}
selectYear.innerHTML = contents2;
arrayOfObjects = [
...
var country = "<option selected>" + 'COUNTRY' + "</option>";
var object = 0;
var array = 0

for (var i = 0; i <= arrayOfObjects.length; i++) {
    object = arrayOfObjects[i];
    country += "<option>" + object.name + "</option>";
